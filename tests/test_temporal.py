...
def test_window_frames_rejected_with_pre_decoder():
    with pytest.raises(ValueError, match="unsupported with placement='pre_decoder'"):
        _module(placement="pre_decoder", image_dim=32, window_frames=5)
