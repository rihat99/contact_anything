...
(2026-09-04/05) is summarised in the last section; the round write-ups are in `docs/old/history/`.
...
## Round 5 (2026-09-07 evening) — `docs/old/round5_2026-09-07.md`
...
claim-by-claim status is the table at the end of `docs/old/plan.md`. The final model's runs are
...
## Round 6 (2026-09-11) — `docs/old/round6_2026-09-11.md`
